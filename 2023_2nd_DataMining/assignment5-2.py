...
# assignment4_output.txt 데이터 받아서 클러스터 저장
...
# assigment4_output.txt 와 ground_truth.txt 의 클러스터 결과 비교
# J-card index 사용
...
# 작업디렉토리에 assignment4.py, assignment4_output.txt, ground_truth.txt 를 넣습니다
# 터미널 창 입력 형식 : 
# python assignment5-1.py assignment4_output.txt ground_truth.txt
# The main function
def main():
    input_filename1 = sys.argv[1]
    input_filename2 = sys.argv[2]

    #input_filename1 = 'assignment4_output.txt'
